_REQUEST_ID_HEADER = {
    ...
    "required": False,
    "description": (
        "Optional correlation ID; echoed as response X-Request-Id and forwarded to "
        "microservices (movies: requestId in movies/logs/combined.log; users/screenings: "
        "request_id in container logs; reservations gRPC: request_id in service logs)."
    ),
}
...
swagger_spec = {
    ...
    "paths": {
        "/health": {"get": {"summary": "Gateway health", "parameters": [_REQUEST_ID_HEADER], "responses": {"200": {"description": "Healthy"}}}},
        "/api/mobile/home": {"get": {"summary": "Mobile home feed", "parameters": [_REQUEST_ID_HEADER], "responses": {"200": {"description": "OK"}}}},
        "/api/mobile/movies": {
            "post": {
                "summary": "Create movie (proxy)",
                "parameters": [_REQUEST_ID_HEADER, {"in": "body", "name": "body", "required": True, "schema": {"$ref": "#/definitions/MovieCreate"}}],
        ...
        "/api/mobile/movies/{movie_id}": {
            "get": {
                ...
                "parameters": [_REQUEST_ID_HEADER, {"in": "path", "name": "movie_id", "required": True, "type": "string", "example": "507f1f77bcf86cd799439011"}],
        ...
        "/api/mobile/users/{user_id}/profile": {
            "get": {
                ...
                "parameters": [_REQUEST_ID_HEADER, {"in": "path", "name": "user_id", "required": True, "type": "string", "example": "507f1f77bcf86cd799439011"}],
                "responses": {"200": {"description": "OK"}, "404": {"description": "Not found"}},
            }
        },
        "/api/mobile/users": {
            "get": {"summary": "List users (proxy)", "parameters": [_REQUEST_ID_HEADER], "responses": {"200": {"description": "OK"}}},
            "post": {
                "summary": "Create user (proxy)",
                "parameters": [_REQUEST_ID_HEADER, {"in": "body", "name": "body", "required": True, "schema": {"$ref": "#/definitions/UserCreate"}}],
                "responses": {"201": {"description": "Created"}},
            },
        },
        ...
        "/api/mobile/screenings": {
            "get": {"summary": "List screenings (proxy)", "parameters": [_REQUEST_ID_HEADER], "responses": {"200": {"description": "OK"}}},
            "post": {
                "summary": "Create screening (proxy)",
                "parameters": [_REQUEST_ID_HEADER, {"in": "body", "name": "body", "required": True, "schema": {"$ref": "#/definitions/ScreeningCreate"}}],
                "responses": {"201": {"description": "Created"}},
            },
        },
        "/api/mobile/screenings/{screening_id}": {
            "get": {
                ...
                "parameters": [_REQUEST_ID_HEADER, {"in": "path", "name": "screening_id", "required": True, "type": "string", "example": "507f1f77bcf86cd799439011"}],
                "responses": {"200": {"description": "OK"}},
            },
            "put": {
        ...
        "/api/mobile/screenings/movie/{movie_id}": {
            "get": {
                ...
                "parameters": [_REQUEST_ID_HEADER, {"in": "path", "name": "movie_id", "required": True, "type": "string", "example": "movie-001"}],
                "responses": {"200": {"description": "OK"}},
            },
        },
        "/api/mobile/reservations": {
            "post": {
                ...
                "parameters": [_REQUEST_ID_HEADER, {"in": "body", "name": "body", "required": True, "schema": {"$ref": "#/definitions/ReservationCreate"}}],
                "responses": {"201": {"description": "Created"}},
            }
        },
        "/api/mobile/reservations/{reservation_id}": {
            "get": {
                ...
                "parameters": [_REQUEST_ID_HEADER, {"in": "path", "name": "reservation_id", "required": True, "type": "string", "example": "67f8f20b92f0cbf2c6100001"}],
                "responses": {"200": {"description": "OK"}},
            },
            "delete": {
        ...
        "/api/mobile/reservations/screening/{screening_id}": {
            "get": {
                ...
                "parameters": [_REQUEST_ID_HEADER, {"in": "path", "name": "screening_id", "required": True, "type": "string", "example": "screening-demo-001"}],
                "responses": {"200": {"description": "OK"}},
            }
        },
